...
<script async type="text/javascript" src="{{ asset('vendor/jquery/jquery-3.2.1.min.js') }}"></script>

<script async type="text/javascript" src="{{ asset('js/app.js') }}"></script>

<script async type="text/javascript" src="{{ asset('vendor/animsition/js/animsition.min.js') }}"></script>

{{--<script type="text/javascript" src="{{ asset('vendor/bootstrap/js/popper.js') }}"></script>--}}
{{--<script type="text/javascript" src="{{ asset('vendor/bootstrap/js/bootstrap.min.js') }}"></script>--}}

<script async type="text/javascript" src="{{ asset('plugins/select2.js') }}"></script>

<script async type="text/javascript" src="{{ asset('vendor/slick/slick.min.js') }}"></script>
<script async type="text/javascript" src="{{ asset('js/frontend/slick-custom.js') }}"></script>

<script async type="text/javascript" src="{{ asset('vendor/countdowntime/countdowntime.js') }}"></script>

<script async type="text/javascript" src="{{ asset('vendor/lightbox2/js/lightbox.min.js') }}"></script>
<script async type="text/javascript" src="{{ asset('vendor/sweetalert/sweetalert.min.js') }}"></script>

<script async type="text/javascript" src="{{ asset('vendor/parallax100/parallax100.js') }}"></script>
